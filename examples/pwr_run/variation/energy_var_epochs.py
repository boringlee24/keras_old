...
tc_list = ['epoch20_resnet50_32', 'epoch40_resnet50_32', 'epoch60_resnet50_32']
...
for testcase in tc_list:
    ...
    pwr_dir = '/scratch/li.baol/GPU_pwr_meas/tensorflow/csv/' + testcase + '.csv'  # /scratch/li.baol/GPU_pwr_meas/tensorflow/K80_vgg19_32_*/
    time_dir = '/scratch/li.baol/GPU_time_meas/tensorflow/csv/' + testcase + '.csv'  # /scratch/li.baol/GPU_pwr_meas/tensorflow/K80_vgg19_32_*/
