...
for testcase in tc_list:
    ...
    log_dir = '/scratch/li.baol/GPU_time_meas/tensorflow/csv/K80_' + testcase + '.csv'  # /scratch/li.baol/GPU_pwr_meas/tensorflow/K80_vgg19_32_*/
