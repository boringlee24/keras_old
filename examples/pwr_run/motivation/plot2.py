...
testcases = {
'Configuration of resnet50 on K80': 'K80_resnet50_0.01', 
'Configuration of resnet50 on P100': 'P100_resnet50_0.01',
'Configuration of densenet121 on K80': 'K80_densenet121_32',
'Configuration of densenet121 on P100': 'P100_densenet121_32' }

base_dir = '/scratch/li.baol/tsrbrd_log/pwr_meas/cmp/'
...
plt.savefig('speed_up_insufficient.png')
