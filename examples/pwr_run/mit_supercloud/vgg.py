...
model_type = args.tc #'P100_VGG16_he_4' 
...
model_name = 'my_test_vgg16.{epoch:03d}.h5'
...
logdir = '/home/gridsan/baolinli/logs/tsrbrd_log/pwr_meas/' + model_type #+ datetime.now().strftime("%Y%m%d-%H%M%S")

tensorboard_callback = TensorBoard(log_dir=logdir, update_freq='epoch')#, update_freq='batch')
