...
def lr_schedule(epoch):
    ...
    return lr
print('testing time for loading checkpoint checkpointing')

##start = time.time()
##model = tf.keras.models.load_model('/scratch/li.baol/checkpoint_test/resnet101.h5')
##end = time.time()
##print(end - start)
...
print('testing time for checkpointing')
start = time.time()
model.save('/scratch/li.baol/checkpoint_test/' + args.model + '.h5')
end = time.time()
print(end - start)
