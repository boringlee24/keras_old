...
save_files = '/scratch/li.baol/checkpoint_feedback_fair_3level/' + job_name + '*'
...
def terminateProcess(signalNumber, frame):
    ...
    for f in glob.glob(save_files):
        os.remove(f)
    model.save('/scratch/li.baol/checkpoint_feedback_fair_3level/' + job_name + '_' + str(current_epoch) + '.h5')
