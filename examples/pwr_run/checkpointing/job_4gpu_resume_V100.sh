...
#SBATCH --gres=gpu:v100-sxm2:4                              # reserves 1 gpu per machine
#SBATCH --cpus-per-task=4
#SBATCH --exclude=c[2184,2192],d1013   #[2204-2207]

srun python ${MYJOB}.py --tc ${MYJOB} --model resnet50 -b 256 --lr 0.001 --resume
