...
#save_files = '/tmp/li.baol/checkpoint_test/' + job_name + '*'
...
def terminateProcess(signalNumber, frame):
    ...
    for f in glob.glob(save_files):
        os.remove(f)
#    if not os.path.exists('/tmp/li.baol/checkpoint_test/'):
#        os.makedirs('/tmp/li.baol/checkpoint_test/')
#    model.save('/tmp/li.baol/checkpoint_test/' + job_name + '_' + str(current_epoch) + '.h5')
